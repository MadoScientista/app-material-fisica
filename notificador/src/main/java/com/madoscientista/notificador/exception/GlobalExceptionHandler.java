package com.madoscientista.notificador.exception;
...
import com.madoscientista.notificador.dto.errorDTO.ResponseErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseErrorDTO> handleFeignException(FeignException e){
        ...
        if(mensajeError.contains("8081")){ // Si contiene el puerto del ms generador-ejercicios
            ...
            campo = "Suscripciones";
        }else if(mensajeError.contains("8085")){ // Si contiene el puerto del ms generador-ejercicios
            campo = "Notificador";
        }else if(mensajeError.contains("8087")){ // Si contiene el puerto del ms generador-ejercicios
            campo = "Usuario";
